...
# Using the above example, I put both criteria in the same function so that the two groups would appear together. Of those against impeachment, 11 were above the median income while 15 were below. Of those for impeachment, 125 were above the median income while 84 were below.
```
